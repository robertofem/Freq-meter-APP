...
class Ui_CalibWindow(object):
    def setupUi(self, CalibWindow):
        ...
        self.horizontalLayout_2.addLayout(self.plotVLayout_coarse)
        self.verticalLayout.addWidget(self.groupBox_coarse)
        ...
        self.horizontalLayout.addLayout(self.plotVLayout_fine)
        self.verticalLayout.addWidget(self.groupBox_fine)
    ...
    def retranslateUi(self, CalibWindow):
        ...
        self.label.setText(_translate("CalibWindow", "Reference device for coarse calibration"))
