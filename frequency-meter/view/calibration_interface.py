...
class Ui_CalibWindow(object):
    def setupUi(self, CalibWindow):
        ...
        self.reference_device = QtWidgets.QGroupBox(self.groupBox_coarse)
        self.reference_device.setObjectName("reference_device")
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout(self.reference_device)
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.verticalLayout_5 = QtWidgets.QVBoxLayout()
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.reference_device_selector = QtWidgets.QComboBox(self.reference_device)
        ...
        self.reference_device_connect = QtWidgets.QPushButton(self.reference_device)
        ...
        self.reference_device_channels = QtWidgets.QGroupBox(self.reference_device)
        ...
        self.reference_device_impedances = QtWidgets.QGroupBox(self.reference_device)
        ...
        self.verticalLayout_2.addWidget(self.reference_device)
        ...
        self.target_device = QtWidgets.QGroupBox(CalibWindow)
        self.target_device.setObjectName("target_device")
        self.horizontalLayout_10 = QtWidgets.QHBoxLayout(self.target_device)
        self.horizontalLayout_10.setObjectName("horizontalLayout_10")
        self.verticalLayout = QtWidgets.QVBoxLayout()
        self.verticalLayout.setObjectName("verticalLayout")
        self.target_device_selector = QtWidgets.QComboBox(self.target_device)
        ...
        self.target_device_connect = QtWidgets.QPushButton(self.target_device)
        ...
        self.target_device_channels = QtWidgets.QGroupBox(self.target_device)
        ...
        self.target_device_impedances = QtWidgets.QGroupBox(self.target_device)
        ...
        self.gridLayout.addWidget(self.target_device, 0, 1, 1, 1)
    ...
    def retranslateUi(self, CalibWindow):
        ...
        self.reference_device.setTitle(_translate("CalibWindow", "Reference device"))
        ...
        self.target_device.setTitle(_translate("CalibWindow", "Target device (to be calibrated)"))
